...
interface HbaseIf
{
     ...
     * @param string $tableName table name
     *
     * @return \Honvid\Hbase\TRegionInfo[]
     * @throws \Honvid\Hbase\IOError
     */
     ...
     *
     * @param \Honvid\Hbase\ColumnDescriptor[] $columnFamilies list of column family descriptors
     *
     * @throws \Honvid\Hbase\IOError
     * @throws \Honvid\Hbase\IllegalArgument
     * @throws \Honvid\Hbase\AlreadyExists
     */
     ...
     * @param array  $attributes Get attributes
     *
     * @return \Honvid\Hbase\TRowResult[]
     * @throws \Honvid\Hbase\IOError
     */
     ...
     * @param string                   $row        row key
     *
     * @param \Honvid\Hbase\Mutation[] $mutations  list of mutation commands
     *
     ...
     * @param string                        $tableName  name of table
     *
     * @param \Honvid\Hbase\BatchMutation[] $rowBatches list of row batches
     *
     * @param array                         $attributes Mutation attributes
     *
     * @throws \Honvid\Hbase\IOError
     ...
     *
     * @param \Honvid\Hbase\TIncrement $increment The single increment to apply
     *
     * @throws \Honvid\Hbase\IOError
     */
    public function increment(\Honvid\Hbase\TIncrement $increment);

    /**
     * @param \Honvid\Hbase\TIncrement[] $increments The list of increments
     *
     * @throws \Honvid\Hbase\IOError
     */
     ...
     * @param string              $tableName  name of table
     *
     * @param \Honvid\Hbase\TScan $scan       Scan instance
     *
     ...
     * @throws \Honvid\Hbase\IOError
     */
    public function scannerOpenWithScan($tableName, \Honvid\Hbase\TScan $scan, array $attributes);
     ...
     * @throws \Honvid\Hbase\IOError
     */
    public function scannerOpenWithStopTs(
        $tableName,
        $startRow,
        $stopRow,
        array $columns,
     ...
     * @param string $row row key
     *
     * @return \Honvid\Hbase\TRegionInfo A TRegionInfo contains information about an HTable region.
     *
     * @throws \Honvid\Hbase\IOError
     */
     ...
     *
     * @param \Honvid\Hbase\TAppend $append The single append operation to apply
     *
     * @return \Honvid\Hbase\TCell[]
     * @throws \Honvid\Hbase\IOError
     */
    public function append(\Honvid\Hbase\TAppend $append);
     ...
     *                                           column in question
     *
     * @param \Honvid\Hbase\Mutation $mput       mutation for the put
     *
     * @param array                  $attributes Mutation attributes
     *
     * @return bool
     ...
     * @throws \Honvid\Hbase\IllegalArgument
     */
    public function checkAndPut($tableName, $row, $column, $value, \Honvid\Hbase\Mutation $mput, array $attributes);
}


class HbaseClient implements \Honvid\Hbase\HbaseIf
{
    ...
    {
        $args = new \Honvid\Hbase\Hbase_enableTable_args();
        $args->tableName = $tableName;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'enableTable', TMessageType::CALL, $args, $this->seqid_,
    ...
    public function recv_enableTable()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_enableTable_result',
            ...
            $result = new \Honvid\Hbase\Hbase_enableTable_result();
    ...
    {
        $args = new \Honvid\Hbase\Hbase_disableTable_args();
        $args->tableName = $tableName;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'disableTable', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_disableTable()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_disableTable_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_disableTable_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_isTableEnabled_args();
        $args->tableName = $tableName;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'isTableEnabled', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_isTableEnabled()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_isTableEnabled_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_isTableEnabled_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
    ...
    {
        $args = new \Honvid\Hbase\Hbase_compact_args();
        $args->tableNameOrRegionName = $tableNameOrRegionName;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'compact', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_compact()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_compact_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_compact_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_majorCompact_args();
        $args->tableNameOrRegionName = $tableNameOrRegionName;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'majorCompact', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_majorCompact()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_majorCompact_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_majorCompact_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_getTableNames_args();
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'getTableNames', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_getTableNames()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_getTableNames_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_getTableNames_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_getColumnDescriptors_args();
        $args->tableName = $tableName;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'getColumnDescriptors', TMessageType::CALL, $args,
    ...
    public function recv_getColumnDescriptors()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_getColumnDescriptors_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_getColumnDescriptors_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_getTableRegions_args();
        $args->tableName = $tableName;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'getTableRegions', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_getTableRegions()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_getTableRegions_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_getTableRegions_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_createTable_args();
        $args->tableName = $tableName;
        $args->columnFamilies = $columnFamilies;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'createTable', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_createTable()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_createTable_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_createTable_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_deleteTable_args();
        $args->tableName = $tableName;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'deleteTable', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_deleteTable()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_deleteTable_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_deleteTable_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_get_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->column = $column;
        ...
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'get', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_get()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_get_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_get_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_getVer_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->column = $column;
        ...
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'getVer', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_getVer()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_getVer_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_getVer_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_getVerTs_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->column = $column;
        ...
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'getVerTs', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_getVerTs()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_getVerTs_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_getVerTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_getRow_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->attributes = $attributes;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'getRow', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_getRow()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_getRow_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_getRow_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_getRowWithColumns_args();
        $args->tableName = $tableName;
        $args->row = $row;
        ...
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'getRowWithColumns', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_getRowWithColumns()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_getRowWithColumns_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_getRowWithColumns_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_getRowTs_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->timestamp = $timestamp;
        $args->attributes = $attributes;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'getRowTs', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_getRowTs()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_getRowTs_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_getRowTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_getRowWithColumnsTs_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->columns = $columns;
        $args->timestamp = $timestamp;
        ...
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'getRowWithColumnsTs', TMessageType::CALL, $args,
                $this->seqid_, $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_getRowWithColumnsTs()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_getRowWithColumnsTs_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_getRowWithColumnsTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_getRows_args();
        $args->tableName = $tableName;
        $args->rows = $rows;
        $args->attributes = $attributes;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'getRows', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_getRows()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_getRows_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_getRows_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_getRowsWithColumns_args();
        $args->tableName = $tableName;
        $args->rows = $rows;
        $args->columns = $columns;
        $args->attributes = $attributes;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'getRowsWithColumns', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_getRowsWithColumns()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_getRowsWithColumns_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_getRowsWithColumns_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_getRowsTs_args();
        $args->tableName = $tableName;
        $args->rows = $rows;
        $args->timestamp = $timestamp;
        $args->attributes = $attributes;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'getRowsTs', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_getRowsTs()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_getRowsTs_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_getRowsTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_getRowsWithColumnsTs_args();
        $args->tableName = $tableName;
        $args->rows = $rows;
        $args->columns = $columns;
        $args->timestamp = $timestamp;
        ...
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'getRowsWithColumnsTs', TMessageType::CALL, $args,
                $this->seqid_, $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_getRowsWithColumnsTs()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_getRowsWithColumnsTs_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_getRowsWithColumnsTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_mutateRow_args();
        $args->tableName = $tableName;
        $args->row = $row;
        ...
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'mutateRow', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_mutateRow()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_mutateRow_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_mutateRow_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_mutateRowTs_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->mutations = $mutations;
        $args->timestamp = $timestamp;
        ...
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'mutateRowTs', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_mutateRowTs()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_mutateRowTs_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_mutateRowTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_mutateRows_args();
        $args->tableName = $tableName;
        $args->rowBatches = $rowBatches;
        $args->attributes = $attributes;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'mutateRows', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_mutateRows()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_mutateRows_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_mutateRows_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_mutateRowsTs_args();
        $args->tableName = $tableName;
        $args->rowBatches = $rowBatches;
        $args->timestamp = $timestamp;
        $args->attributes = $attributes;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'mutateRowsTs', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_mutateRowsTs()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_mutateRowsTs_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_mutateRowsTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_atomicIncrement_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->column = $column;
        $args->value = $value;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'atomicIncrement', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_atomicIncrement()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_atomicIncrement_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_atomicIncrement_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_deleteAll_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->column = $column;
        $args->attributes = $attributes;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'deleteAll', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_deleteAll()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_deleteAll_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_deleteAll_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_deleteAllTs_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->column = $column;
        $args->timestamp = $timestamp;
        ...
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'deleteAllTs', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_deleteAllTs()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_deleteAllTs_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_deleteAllTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_deleteAllRow_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->attributes = $attributes;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'deleteAllRow', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_deleteAllRow()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_deleteAllRow_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_deleteAllRow_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    public function send_increment(\Honvid\Hbase\TIncrement $increment)
    {
        $args = new \Honvid\Hbase\Hbase_increment_args();
        $args->increment = $increment;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'increment', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_increment()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_increment_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_increment_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_incrementRows_args();
        $args->increments = $increments;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'incrementRows', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_incrementRows()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_incrementRows_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_incrementRows_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_deleteAllRowTs_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->timestamp = $timestamp;
        $args->attributes = $attributes;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'deleteAllRowTs', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_deleteAllRowTs()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_deleteAllRowTs_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_deleteAllRowTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    public function send_scannerOpenWithScan($tableName, \Honvid\Hbase\TScan $scan, array $attributes)
    {
        $args = new \Honvid\Hbase\Hbase_scannerOpenWithScan_args();
        $args->tableName = $tableName;
        $args->scan = $scan;
        $args->attributes = $attributes;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'scannerOpenWithScan', TMessageType::CALL, $args,
                $this->seqid_, $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_scannerOpenWithScan()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_scannerOpenWithScan_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_scannerOpenWithScan_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_scannerOpen_args();
        $args->tableName = $tableName;
        ...
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'scannerOpen', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_scannerOpen()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_scannerOpen_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_scannerOpen_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_scannerOpenWithStop_args();
        $args->tableName = $tableName;
        $args->startRow = $startRow;
        ...
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'scannerOpenWithStop', TMessageType::CALL, $args,
                $this->seqid_, $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_scannerOpenWithStop()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_scannerOpenWithStop_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_scannerOpenWithStop_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_scannerOpenWithPrefix_args();
        $args->tableName = $tableName;
        ...
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'scannerOpenWithPrefix', TMessageType::CALL, $args,
                $this->seqid_, $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_scannerOpenWithPrefix()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_scannerOpenWithPrefix_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_scannerOpenWithPrefix_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_scannerOpenTs_args();
        $args->tableName = $tableName;
        $args->startRow = $startRow;
        $args->columns = $columns;
        $args->timestamp = $timestamp;
        ...
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'scannerOpenTs', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_scannerOpenTs()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_scannerOpenTs_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_scannerOpenTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_scannerOpenWithStopTs(
        $tableName,
        $startRow,
        $stopRow,
        array $columns,
        ...
        $args = new \Honvid\Hbase\Hbase_scannerOpenWithStopTs_args();
        $args->tableName = $tableName;
        $args->startRow = $startRow;
        $args->stopRow = $stopRow;
        $args->columns = $columns;
        ...
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'scannerOpenWithStopTs', TMessageType::CALL, $args,
                $this->seqid_, $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_scannerOpenWithStopTs()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_scannerOpenWithStopTs_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_scannerOpenWithStopTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_scannerGet_args();
        $args->id = $id;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'scannerGet', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_scannerGet()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_scannerGet_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_scannerGet_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_scannerGetList_args();
        $args->id = $id;
        $args->nbRows = $nbRows;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'scannerGetList', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_scannerGetList()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_scannerGetList_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_scannerGetList_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_scannerClose_args();
        $args->id = $id;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'scannerClose', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_scannerClose()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_scannerClose_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_scannerClose_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    {
        $args = new \Honvid\Hbase\Hbase_getRegionInfo_args();
        $args->row = $row;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'getRegionInfo', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_getRegionInfo()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_getRegionInfo_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_getRegionInfo_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_append(\Honvid\Hbase\TAppend $append)
    {
        $args = new \Honvid\Hbase\Hbase_append_args();
        $args->append = $append;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'append', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_append()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_append_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_append_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_checkAndPut($tableName, $row, $column, $value, \Honvid\Hbase\Mutation $mput, array $attributes)
    {
        $args = new \Honvid\Hbase\Hbase_checkAndPut_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->column = $column;
        $args->value = $value;
        ...
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary($this->output_, 'checkAndPut', TMessageType::CALL, $args, $this->seqid_,
                $this->output_->isStrictWrite());
        } else {
    ...
    public function recv_checkAndPut()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary($this->input_, '\Honvid\Hbase\Hbase_checkAndPut_result',
                $this->input_->isStrictRead());
        } else {
            $rseqid = 0;
            $fname = null;
            ...
            $result = new \Honvid\Hbase\Hbase_checkAndPut_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
...
class Hbase_enableTable_result
{
    ...
    static $_TSPEC = [
        1 => [
            ...
            'isRequired' => false,
            'type'       => TType::STRUCT,
            'class'      => '\Honvid\Hbase\IOError',
        ],
    ];

    /**
     * @var \Honvid\Hbase\IOError
     */
    public $io = null;
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->io = new \Honvid\Hbase\IOError();
...
class Hbase_getColumnDescriptors_result
{
    ...
    static $_TSPEC = [
        0 => [
            ...
            'val'        => [
                'type'  => TType::STRUCT,
                'class' => '\Honvid\Hbase\ColumnDescriptor',
            ],
        ],
        1 => [
            'var'        => 'io',
                ...
                case 0:
                    if ($ftype == TType::MAP) {
                        ...
                        for ($_i55 = 0; $_i55 < $_size51; ++$_i55) {
                            $key56 = '';
                            $val57 = new \Honvid\Hbase\ColumnDescriptor();
...
class Hbase_getTableRegions_result
{
    ...
    static $_TSPEC = [
        0 => [
            ...
            'elem'       => [
                'type'  => TType::STRUCT,
                'class' => '\Honvid\Hbase\TRegionInfo',
            ],
        ],
        1 => [
            'var'        => 'io',
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i64 = 0; $_i64 < $_size60; ++$_i64) {
                            $elem65 = null;
                            $elem65 = new \Honvid\Hbase\TRegionInfo();
...
class Hbase_createTable_args
{
     ...
     *
     * @var \Honvid\Hbase\ColumnDescriptor[]
     */
                ...
                case 2:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i71 = 0; $_i71 < $_size67; ++$_i71) {
                            $elem72 = null;
                            $elem72 = new \Honvid\Hbase\ColumnDescriptor();
...
class Hbase_createTable_result
{
    ...
    static $_TSPEC = [
        ...
        2 => [
            ...
            'isRequired' => false,
            'type'       => TType::STRUCT,
            'class'      => '\Honvid\Hbase\IllegalArgument',
        ],
        3 => [
            'var'        => 'exist',
            'isRequired' => false,
            'type'       => TType::STRUCT,
            'class'      => '\Honvid\Hbase\AlreadyExists',
        ],
    ];
    ...
    public $io = null;
    /**
     * @var \Honvid\Hbase\IllegalArgument
     */
    public $ia = null;
    /**
     * @var \Honvid\Hbase\AlreadyExists
     */
    public $exist = null;
    ...
    public function read($input)
    {
        ...
        while (true) {
            ...
            switch ($fid) {
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->ia = new \Honvid\Hbase\IllegalArgument();
                ...
                case 3:
                    if ($ftype == TType::STRUCT) {
                        $this->exist = new \Honvid\Hbase\AlreadyExists();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i103 = 0; $_i103 < $_size99; ++$_i103) {
                            $elem104 = null;
                            $elem104 = new \Honvid\Hbase\TCell();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i119 = 0; $_i119 < $_size115; ++$_i119) {
                            $elem120 = null;
                            $elem120 = new \Honvid\Hbase\TCell();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i135 = 0; $_i135 < $_size131; ++$_i135) {
                            $elem136 = null;
                            $elem136 = new \Honvid\Hbase\TRowResult();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i158 = 0; $_i158 < $_size154; ++$_i158) {
                            $elem159 = null;
                            $elem159 = new \Honvid\Hbase\TRowResult();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i174 = 0; $_i174 < $_size170; ++$_i174) {
                            $elem175 = null;
                            $elem175 = new \Honvid\Hbase\TRowResult();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i197 = 0; $_i197 < $_size193; ++$_i197) {
                            $elem198 = null;
                            $elem198 = new \Honvid\Hbase\TRowResult();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i220 = 0; $_i220 < $_size216; ++$_i220) {
                            $elem221 = null;
                            $elem221 = new \Honvid\Hbase\TRowResult();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i250 = 0; $_i250 < $_size246; ++$_i250) {
                            $elem251 = null;
                            $elem251 = new \Honvid\Hbase\TRowResult();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i273 = 0; $_i273 < $_size269; ++$_i273) {
                            $elem274 = null;
                            $elem274 = new \Honvid\Hbase\TRowResult();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i303 = 0; $_i303 < $_size299; ++$_i303) {
                            $elem304 = null;
                            $elem304 = new \Honvid\Hbase\TRowResult();
                ...
                case 3:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i310 = 0; $_i310 < $_size306; ++$_i310) {
                            $elem311 = null;
                            $elem311 = new \Honvid\Hbase\Mutation();
                ...
                case 3:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i326 = 0; $_i326 < $_size322; ++$_i326) {
                            $elem327 = null;
                            $elem327 = new \Honvid\Hbase\Mutation();
...
class Hbase_mutateRows_args
{
    ...
    static $_TSPEC = [
        ...
        2 => [
            ...
            'elem'       => [
                'type'  => TType::STRUCT,
                'class' => '\Honvid\Hbase\BatchMutation',
            ],
        ],
        3 => [
            'var'        => 'attributes',
     ...
     * list of row batches
     *
     * @var \Honvid\Hbase\BatchMutation[]
     */
                ...
                case 2:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i342 = 0; $_i342 < $_size338; ++$_i342) {
                            $elem343 = null;
                            $elem343 = new \Honvid\Hbase\BatchMutation();
                ...
                case 2:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i358 = 0; $_i358 < $_size354; ++$_i358) {
                            $elem359 = null;
                            $elem359 = new \Honvid\Hbase\BatchMutation();
    ...
    public function read($input)
    {
        ...
        while (true) {
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->increment = new \Honvid\Hbase\TIncrement();
                ...
                case 1:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i401 = 0; $_i401 < $_size397; ++$_i401) {
                            $elem402 = null;
                            $elem402 = new \Honvid\Hbase\TIncrement();
    ...
    public function read($input)
    {
        ...
        while (true) {
            ...
            switch ($fid) {
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->scan = new \Honvid\Hbase\TScan();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i506 = 0; $_i506 < $_size502; ++$_i506) {
                            $elem507 = null;
                            $elem507 = new \Honvid\Hbase\TRowResult();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i513 = 0; $_i513 < $_size509; ++$_i513) {
                            $elem514 = null;
                            $elem514 = new \Honvid\Hbase\TRowResult();
    ...
    public function read($input)
    {
        ...
        while (true) {
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::STRUCT) {
                        $this->success = new \Honvid\Hbase\TRegionInfo();
    ...
    public function read($input)
    {
        ...
        while (true) {
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->append = new \Honvid\Hbase\TAppend();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i520 = 0; $_i520 < $_size516; ++$_i520) {
                            $elem521 = null;
                            $elem521 = new \Honvid\Hbase\TCell();
    ...
    public function read($input)
    {
        ...
        while (true) {
            ...
            switch ($fid) {
                ...
                case 6:
                    if ($ftype == TType::STRUCT) {
                        $this->mput = new \Honvid\Hbase\Mutation();
